"""The unical_owerone integration."""
...
type UnicalConfigEntry = ConfigEntry[RuntimeData]

async def async_setup_entry(hass: HomeAssistant, config_entry: UnicalConfigEntry) -> bool:
    """Set up Example Integration from a config entry."""

    # Initialise the coordinator that manages data updates from your api.
    # This is defined in coordinator.py
    coordinator = UnicalCoordinator(hass,
                                    config_entry)
    ...
    if not coordinator.api.check_connection:
    ...
    # Add thd update coordinator ane listener to config runtime data to make
...
async def async_unload_entry(hass: HomeAssistant, config_entry: UnicalConfigEntry) -> bool:
